...
public class InstitutoController {
    ...
    public ResponseEntity cadastro(@RequestBody @Valid DadosCadastroInstituto dados, UriComponentsBuilder uriBuilder) {
        // Cria um novo Instituto com base nos dados fornecidos e o salva no
        // repositório.
        var instituto = new Instituto(dados);
        repository.save(instituto);

        // Gera uma URI para o novo Instituto e retorna uma resposta com o Instituto
        // criado.
    ...
    @GetMapping()
    public ResponseEntity<Page<DadosListagemInstituto>> listar(
            @PageableDefault(sort = { "acronimo" }) Pageable paginacao) {
    ...
    public ResponseEntity encontrarPorID(@PathVariable Long id) {
        // Obtém uma referência para o Instituto pelo ID e retorna os dados desse
        // Instituto.
    ...
    public ResponseEntity encontrarAcronimo(@PathVariable String ac) {
        // Obtém todos os Institutos com o acrônimo fornecido e retorna os dados de um
        // deles.
    ...
    public ResponseEntity encontrarNome(@PathVariable String nome) {
        // Obtém todos os Institutos com o nome fornecido e retorna os dados de um
        // deles.
    ...
    public ResponseEntity deletarInstituto(@PathVariable Long id) {
        // Obtém uma referência para o Instituto pelo ID, marca-o como excluído e o
    ...
    public ResponseEntity atualiza(@RequestBody @Valid DadosAtualizarInstituto dados) {
        // Obtém uma referência para o Instituto pelo ID, atualiza seus dados com base
        // nos novos dados fornecidos e o salva no repositório.
